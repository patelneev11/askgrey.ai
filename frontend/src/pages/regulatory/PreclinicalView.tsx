    ...
    <div className={styles.output}>
      ...
      {report.fixture_draft && (
        <p className={styles.hint} role="note">
          Fixture output, not a draft: the development fixture drafter writes deliberately
          incorrect numbers so the discrepancy audit below can be exercised, and none of it
          describes the submitted study. Drafter {report.drafter}.
        </p>
      )}
